...
public class Id extends AppCompatActivity {
    ...
    Button ImgChoose, ImgUpload, ViewImage;
    ImageView ImgView;
                ...
                if (filePath != null) {
                    ...
                    uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            pd.dismiss();
                            Toast.makeText(Id.this, "Upload successful", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(Id.this, "Upload Failed -> " + e, Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    Toast.makeText(Id.this, "Select an image", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
